...
(function () {
  ...
  const FRAGMENTS = [
    'USCFITNESSHUB/header.html',      // optional header fragment (if you keep header inline in a fragment)
    'USCFITNESSHUB/home.html',
    'USCFITNESSHUB/gyms.html',
    'USCFITNESSHUB/nutrition.html',
    'USCFITNESSHUB/calculator.html',
    'USCFITNESSHUB/forms.html',
    'USCFITNESSHUB/footer.html'       // optional footer fragment
  ];
